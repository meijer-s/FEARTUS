...
out_dir <- here::here(
  ...
  "amy_vs_hip", "reext_unr_CSxTUSxEXP"
)
...
write.table(
  data_wide,
  file      = file.path(out_dir, "data_reext_unr_CSxTUSxEXP.csv"),
  row.names = FALSE,
...
write.table(
  ...
  file      = file.path(out_dir, "blocks_reext_unr_CSxTUSxEXP.csv"),
  row.names = FALSE,
  col.names = FALSE,
  sep       = ","
)
...
write.table(
  design_matrix_df,
  file      = file.path(out_dir, "design_reext_unr_CSxTUSxEXP.csv"),
  row.names = FALSE,
  col.names = FALSE,
  sep       = ","
)
...
write.table(
  contrast_matrix_df,
  file      = file.path(out_dir, "contrast_reext_unr_CSxTUSxEXP.csv"),
  row.names = FALSE,
  col.names = FALSE,
  sep       = ","
)
